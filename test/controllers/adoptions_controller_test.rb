...
class AdoptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adoption" do
    assert_difference('Adoption.count') do
      post adoptions_url, params: { adoption: { address: @adoption.address, latitude: @adoption.latitude, longitude: @adoption.longitude, pet_id: @adoption.pet_id } }
    end
  ...
  test "should update adoption" do
    patch adoption_url(@adoption), params: { adoption: { address: @adoption.address, latitude: @adoption.latitude, longitude: @adoption.longitude, pet_id: @adoption.pet_id } }
