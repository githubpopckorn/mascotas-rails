...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { codigo: @state.codigo, estado: @state.estado, pet_id: @state.pet_id } }
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { codigo: @state.codigo, estado: @state.estado, pet_id: @state.pet_id } }
