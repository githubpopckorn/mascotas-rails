class AdoptionsController < ApplicationController
  ...
  def contrato
    ...
    respond_to do |format|
      format.pdf { render template: 'adoptions/contract', pdf: "contrato de adopcion"}
    end
  end
  ...
  def create
    ...
    respond_to do |format|
      if @adoption.save
        @adoption.pet.update(estado: "adoptada")
  ...
  private
    ...
    def adoption_params
      params.require(:adoption).permit(:pet_id, :latitude, :longitude, :address)
    end
end
